package com.wh136.xyz.common.datasource;
...
//@Configuration
//@MapperScan(value = "com.uca.**.mapper",sqlSessionFactoryRef = "sqlSessionFactoryBeanNetworkCore")
public class NetworkCoreDataSourceConfig extends DataSourceConfig {
    ...
    public DataSource dataSourceNetworkCore() {
        return initDataSource("uni_network_basic");
    }
    ...
    public SqlSessionFactory sqlSessionFactoryBeanNetworkCore() {
        ...
        try {
//            sqlSessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:test/*.xml"));
